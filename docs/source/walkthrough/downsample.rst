...
Downsampling for the mask and the image layer have to be done separately, becuase images are downsampled with average pooling strategy while masks are downsampled
